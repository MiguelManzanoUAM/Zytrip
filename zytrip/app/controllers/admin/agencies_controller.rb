class AgenciesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @agency.save
        format.html { redirect_to agency_url(@agency), notice: "Agency was successfully created." }
  ...
  def update
    respond_to do |format|
      if @agency.update(agency_params)
        format.html { redirect_to agency_url(@agency), notice: "Agency was successfully updated." }
