...
User.create!(name:"Nautilus", surname: "Viajes", admin:false, password:"nautilUs01", email:"nautilus@email.es", id:2, image:"users/nautilus.png")

User.create!(name:"Viajes", surname: "El Turista Inglés", admin:false, password:"turistaIngles02", email:"viajeselturistaingles@email.es", id:3, image:"users/turista_ingles.png")
...
User.create!(id: 4, name:"Marisol", surname:"del Bayo", email:"maribayo@outlook.es", password:"baYosol61", admin:false)
User.create!(id: 5, name:"Germán", surname:"Menéndez", email:"gemendez@outlook.es", password:"mendeZdeZ", admin:false)
User.create!(id: 6, name:"Jose", surname:"Cid Arango", email:"josecarango@hotmail.es", password:"arangoCid87", admin:false)
User.create!(id: 7, name:"Sergio", surname:"Vizcaíno", email:"sergiovz@outlook.es", password:"vizcaSrgo", admin:false)
User.create!(id: 8, name:"Valeria", surname:"Madrigal", email:"valmagal@outlook.es", password:"Valevalem95", admin:false)
User.create!(id: 9, name:"Soraya", surname:"Cardona", email:"scardona@yahoo.es", password:"Sorydona97", admin:false)
User.create!(id: 10, name:"Iker", surname:"Nilo Vaquero", email:"ikernilovaq@hotmail.es", password:"niloVaqIkerR", admin:false)
User.create!(id: 11, name:"Édgar", surname:"Cortés", email:"edgarcortesp@outlook.es", password:"CortesPartn96", admin:false)
User.create!(id: 12, name:"Julián", surname:"Palomino", email:"jpalomino@outlook.es", password:"butrpalmjN22", admin:false)
User.create!(id: 13, name:"Gabriel", surname:"Galindo", email:"gabgalindo@hotmail.es", password:"gGaldrielDo05", admin:false)
User.create!(id: 14, name:"Cristina", surname:"Galán Bautista", email:"cristigalan@outlook.es", password:"bauCrGalan", admin:false)
User.create!(id: 15, name:"Lorenzo", surname:"Anglada", email:"lordanglada@hotmail.es", password:"angManjLor92", admin:false)
User.create!(id: 16, name:"Sara", surname:"Valenzuela", email:"saritavalen@hotmail.es", password:"ValenzaRa99", admin:false)
User.create!(id: 17, name:"Águeda", surname:"del Carpio", email:"aguedelcarpio@outlook.es", password:"dCarpGuedA", admin:false)
User.create!(id: 18, name:"Jaime", surname:"Mendoza", email:"jmendoza@hotmail.es", password:"menBerger97", admin:false)
User.create!(id: 19, name:"Lara", surname:"Lorenzo", email:"laraenzo@outlook.es", password:"renzoiZaguirre99", admin:false)
User.create!(id: 20, name:"Flavio", surname:"Palma", email:"flapalma@outlook.es", password:"palmaBillarFla98", admin:false)
User.create!(id: 21, name:"Luis", surname:"Salmerón", email:"lusalmon@outlook.es", admin: false, password:"salmeUi99s")
